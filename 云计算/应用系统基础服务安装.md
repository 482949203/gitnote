...
yun源安装失败使用：
原因分析：yum源中没有Elasticsearch这个包，所以我使用的方法是直接下去官网下载压缩文件，这里提供下载地址
...
安装ZooKeeper服务
安装包下载：https://www.apache.org/dyn/closer.lua/zookeeper/zookeeper-3.6.1/apache-zookeeper-3.6.1-bin.tar.gz
